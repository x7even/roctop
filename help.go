...
func renderHelp(width int) string {
	...
	lines := []string{
		...
		helpTextStyle.Render("PWR, and TEMP. Columns are steel blue, turning amber at 75% and"),
		helpTextStyle.Render("red at 90% of the scale — the same thresholds as the bars."),
